...
<div class={cn("flex items-center space-x-2 opacity-80", className)}>
  <svg xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 36 36">
    ...
    <path fill="currentColor" d="M10 10a1 1 0 0 0 1-1V3a1 1 0 0 0-2 0v6a1 1 0 0 0 1 1Z" class="clr-i-outline clr-i-outline-path-14"/>
    <path fill="currentColor" d="M26 10a1 1 0 0 0 1-1V3a1 1 0 0 0-2 0v6a1 1 0 0 0 1 1Z" class="clr-i-outline clr-i-outline-path-15"/>
