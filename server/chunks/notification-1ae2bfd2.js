import { c as create_ssr_component, v as validate_component, e as escape, f as compute_rest_props, n as getContext, b as add_attribute, g as spread, h as escape_object, i as escape_attribute_value, k as compute_slots, z as createEventDispatcher } from './index3-8d921900.js';
import { c as classNames } from './Indicator.svelte_svelte_type_style_lang-e7e27c71.js';
import { L as Label } from './Label-5025b584.js';
import { I as Input } from './Input-979dea64.js';
import { W as Wrapper } from './Wrapper-d29eca5d.js';
import { t as toast } from './Toaster.svelte_svelte_type_style_lang-7966b34d.js';
...
const DateTimePicker = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Flatpickr, "Flatpickr").$$render(
    $$result,
    {
      options,
      element: "#date-picker",
    ...
    {
      default: () => {
        return `<div class="flatpickr" id="date-picker">${validate_component(Input, "Input").$$render(
          $$result,
          {
            type: "text",
            name,
...
const FormInput = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Label, "Label").$$render($$result, { class: "space-y-2" }, {}, {
    default: () => {
      return `<span>${escape(label === "" ? title : label)}</span>

	${textarea ? `${validate_component(Textarea, "Textarea").$$render($$result, { name, placeholder, value, rows }, {}, {})}` : `${type === "datetime-local" ? `${validate_component(DateTimePicker, "DateTimePicker").$$render($$result, { name, placeholder, value }, {}, {})}` : `${validate_component(Input, "Input").$$render(
        $$result,
        {
          type,
          name,
	...
	${messages ? `<div class="text-red-500 text-sm">${escape(message)}</div>` : ``}`;
    }
  })}`;
});
...
export { FormInput as F, notify as n };
//# sourceMappingURL=notification-1ae2bfd2.js.map
