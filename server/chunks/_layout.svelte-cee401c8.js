import { c as create_ssr_component, v as validate_component, b as subscribe, e as escape, d as add_attribute, f as each, o as onDestroy, g as compute_rest_props, s as setContext, h as spread, j as escape_object, k as escape_attribute_value, l as add_styles, p as compute_slots, q as is_void, t as getContext, m as missing_component, u as merge_ssr_styles, w as get_current_component, x as globals } from './index3-4f698b40.js';
import { u as useToasterStore, t as toast, s as startPause, e as endPause, a as update, p as prefersReducedMotion } from './Toaster.svelte_svelte_type_style_lang-71c236cf.js';
import { p as page } from './stores-89e83f53.js';
import { c as classNames, B as Button } from './Indicator.svelte_svelte_type_style_lang-bbc32287.js';
import { F as Frame, T as ToolbarButton } from './ToolbarButton-a2f70ceb.js';
import { F as Fa, f as faUser, a as faMoon, b as faHouse, c as faSearch } from './fa-65609c29.js';
...
const ToastIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${typeof icon === "string" ? `<div class="${"animated svelte-1yutmpl"}">${escape(icon)}</div>` : `${typeof icon !== "undefined" ? `${validate_component(icon || missing_component, "svelte:component").$$render($$result, {}, {}, {})}` : `${type !== "blank" ? `<div class="${"indicator svelte-1yutmpl"}">${validate_component(LoaderIcon, "LoaderIcon").$$render($$result, Object.assign({}, iconTheme), {}, {})}
		${type !== "loading" ? `<div class="${"status svelte-1yutmpl"}">${type === "error" ? `${validate_component(ErrorIcon, "ErrorIcon").$$render($$result, Object.assign({}, iconTheme), {}, {})}` : `${validate_component(CheckmarkIcon, "CheckmarkIcon").$$render($$result, Object.assign({}, iconTheme), {}, {})}`}</div>` : ``}</div>` : ``}`}`}`;
});
const css$3 = {
...
const AccountButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.user === void 0 && $$bindings.user && user !== void 0)
    $$bindings.user(user);
  return `${user ? `${validate_component(Button, "Button").$$render(
    $$result,
    {
      pill: true,
      id: "avatar_with_name",
    ...
    {
      default: () => {
        return `${validate_component(Fa, "Fa").$$render($$result, { icon: faUser, class: "mr-2" }, {}, {})}
		<span class="${"text-lg font-semibold"}">${escape(user.username)}</span>`;
      }
    }
  )}
    ...
    {
      default: () => {
        return `${validate_component(DropdownItem, "DropdownItem").$$render($$result, { href: "/user" }, {}, {
          default: () => {
            return `User dashboard`;
          }
        })}
		${validate_component(DropdownItem, "DropdownItem").$$render($$result, { href: `/profile/${user.username}` }, {}, {
          default: () => {
            return `Profile`;
          }
        })}
		${validate_component(DropdownDivider, "DropdownDivider").$$render(
          $$result,
          {
            divClass: "my-1 h-px bg-gray-100 dark:bg-gray-600 w-full"
          },
          {},
          {}
        )}
...
const Logo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
	...
	<span class="${"self-center whitespace-nowrap text-xl font-semibold dark:text-white my-auto"}">EloToJa
	</span>`;
    }
  })}`;
});
const SearchBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Button, "Button").$$render(
    ...
    {
      default: () => {
        return `${$page.route.id === "/search" ? `${validate_component(Fa, "Fa").$$render($$result, { icon: faHouse, class: "m-auto" }, {}, {})}` : `${validate_component(Fa, "Fa").$$render($$result, { icon: faSearch, class: "m-auto" }, {}, {})}`}`;
      }
    }
  )}`;
});
const Navbar_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  let { user } = $$props;
  const links = [{ id: "/", name: "Home" }, { id: "/contact", name: "Contact" }];
  if ($$props.user === void 0 && $$bindings.user && user !== void 0)
    $$bindings.user(user);
  $$unsubscribe_page();
  return `${validate_component(Navbar, "Navbar").$$render(
	...
	<div class="${"flex md:order-2 "}">${validate_component(SearchBar, "SearchBar").$$render($$result, {}, {}, {})}
		${validate_component(DarkMode, "DarkMode").$$render($$result, {}, {}, {})}
		${validate_component(AccountButton, "AccountButton").$$render($$result, { user }, {}, {})}
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `${validate_component(Toaster, "Toaster").$$render($$result, { gutter: -52 }, {}, {})}
<div class="${"relative px-1 dark:text-gray-100 dark:bg-gray-800"}">${validate_component(Navbar_1, "Navbar").$$render($$result, { user: data.user }, {}, {})}
	<div class="${"overflow-auto pb-8 pt-16 md:pt-24 h-screen"}"><div class="${"container mx-auto text-justify"}">${slots.default ? slots.default({}) : ``}</div></div></div>`;
});
