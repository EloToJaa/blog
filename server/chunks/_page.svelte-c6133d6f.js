...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-1sp6mfu_START -->${$$result.title = `<title>Update an article</title>`, ""}<!-- HEAD_svelte-1sp6mfu_END -->`, ""}

<form class="flex flex-col space-y-6" method="POST" action="?/update"><h3>Update an article</h3>
...
//# sourceMappingURL=_page.svelte-c6133d6f.js.map
